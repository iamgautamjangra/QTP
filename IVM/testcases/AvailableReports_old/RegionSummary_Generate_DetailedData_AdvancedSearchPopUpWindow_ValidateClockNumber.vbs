...
'
' File Name						:	RegionSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateClockNumber
...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "RegionSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateClockNumber", "REP_RSR_TC_043"
...
With ivm.page(detailedData_page)	
							...
							wait Wait5	
							.webTable("DetailedData_RS").assertDelValue strClockNumber1
							...
							REM .webTable("DetailedData_RS").assertValue strClockNumber1,"4"
							REM wait Wait5
...
REM 'For invalid
							...
							.webTable("DetailedData_RS").assertDelValue strClockNumber
							.webTable("DetailedData_RS").assertDelValue strClockNumber1
							wait Wait5
							...
							REM .webTable("DetailedData_RS").assertValue strClockNumber,"4"
...
End with
executionController.stopTestCase_w_TestCaseNumber "RegionSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateClockNumber", "REP_RSR_TC_043"