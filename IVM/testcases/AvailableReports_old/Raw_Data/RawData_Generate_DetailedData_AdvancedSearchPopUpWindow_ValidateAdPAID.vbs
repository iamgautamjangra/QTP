...
With ivm.page(detailedData_page)	
						   ...
						   .webLink("AdvancedSearch").press
							...
							.webElement("AdPAID_Filter").assertText  "Ad PAID ="& mid(strAdPAID,1,10) &".." &"   X"
							...
							.webTable("DetailedData_RD").assertValue strAdPAID,"17"
							wait 5	
							.webTable("DetailedData_RD").assertDelValue strAdPAID1
							...
							.webTable("DetailedData_RD").assertValue strAdPAID1,"17"
							wait 5
...
REM 'For invalid
							...
							.webTable("DetailedData_RD").assertDelValue strAdPAID
							.webTable("DetailedData_RD").assertDelValue strAdPAID1
							wait 5
