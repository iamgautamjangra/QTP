...
'---------------Assert Back to previous webLink-----------------------
					   ...
					   .webLink("AdvanceSearch_RS").assertExist "True"
					   .webLink("AdvanceSearch_RS").assertStatus "Visible"
...
'---------------Assert header-----------------------------------------
						...
						.webElement("GenerateRegionSummaryReport").assertExist "True"
						.webElement("GenerateRegionSummaryReport").assertStatus "Visible"
