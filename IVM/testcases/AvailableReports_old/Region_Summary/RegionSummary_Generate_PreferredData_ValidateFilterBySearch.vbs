...
'
' File Name						:	RegionSummary_Generate_PreferredData_ValidateFilterBySearch
...
'Start Test Case
 executionController.startTestCase_w_TestCaseNumber "RegionSummary_Generate_PreferredData_ValidateFilterBySearch", "REP_RSR_TC_023"
...
With ivm.page(reportgen_page)
							...
							.webLink("Search_RS").assertExist "True"
							.webLink("Search_RS").assertStatus "Visible"
							
							.webLink("ClearAll_RS").assertExist "True"
							.webLink("ClearAll_RS").assertStatus "Visible"
							
							.webLink("Search_RS").press							
							 wait 5
							
							.webLink("Search_RS").assertExist "False"
...
'End Test Case 
executionController.stopTestCase_w_TestCaseNumber "RegionSummary_Generate_PreferredData_ValidateFilterBySearch", "REP_RSR_TC_023"
