...
with ivm.page(reportgen_page)
							...
							.webElement("AdvertisementAndProgramDetailsReport").assertExist "True"
							.webElement("AdvertisementAndProgramDetailsReport").assertStatus "Visible"
							...
							.webLink("ExportToAPDV").assertExist "True"
							.webLink("ExportToAPDV").assertStatus "Visible"
