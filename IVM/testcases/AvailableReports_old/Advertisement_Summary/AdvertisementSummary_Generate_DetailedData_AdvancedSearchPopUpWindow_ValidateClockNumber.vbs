...
'
' File Name						:	AdvertisementSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateClockNumber
...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "AdvertisementSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateClockNumber", "REP_ASR_TC_043"
...
With ivm.page(detailedData_page)	
							...
							.webTable("DetailedData_AS").assertValue strClockNumber,"4"
							wait 5	
							.webTable("DetailedData_AS").assertDelValue strClockNumber1
...
REM 'For invalid
							...
							.webTable("DetailedData_AS").assertDelValue strClockNumber
							.webTable("DetailedData_AS").assertDelValue strClockNumber1
							wait 5
...
End with
'End Test Case
executionController.stopTestCase_w_TestCaseNumber "AdvertisementSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateClockNumber", "REP_ASR_TC_043"