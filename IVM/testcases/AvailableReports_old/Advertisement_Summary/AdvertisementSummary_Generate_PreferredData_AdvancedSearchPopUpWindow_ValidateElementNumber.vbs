...
With ivm.page(preferredData_page)	
							...
							.webTable("PreferredData_AS").assertValue strElementNumber,"2"
							wait 5	
							.webTable("PreferredData_AS").assertDelValue strElementNumber1
...
REM 'For invalid
							...
							.webTable("PreferredData_AS").assertDelValue strElementNumber
							.webTable("PreferredData_AS").assertDelValue strElementNumber1
							wait 5
