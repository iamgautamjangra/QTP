...
'
' File Name						:	AdvertisementSummary_Generate_PreferredData_AdvancedSearchPopUpWindow_ValidateTimeRange 
' Description					:	Validate the Advanced Search  Time Range
' Author 						:   SeaChange
' Date 							:   03-07-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

'Start Test Case
executionController.startTestCase_w_TestCaseNumber "AdvertisementSummary_Generate_PreferredData_AdvancedSearchPopUpWindow_ValidateTimeRange ", "REP_ASR_TC_028"
...
With ivm.page(preferredData_page)
							...
							.webTable("PreferredData_AS").assertValue strTimeRange,"1"
							wait 5	
							.webTable("PreferredData_AS").assertDelValue strTimeRange1
...
End with						  
'End Test Case
executionController.stopTestCase_w_TestCaseNumber "AdvertisementSummary_Generate_PreferredData_AdvancedSearchPopUpWindow_ValidateTimeRange ", "REP_ASR_TC_028"