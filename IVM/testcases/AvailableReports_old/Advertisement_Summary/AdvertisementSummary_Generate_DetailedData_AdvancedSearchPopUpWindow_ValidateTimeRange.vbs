...
'
' File Name						:	AdvertisementSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateTimeRange 
...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "AdvertisementSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateTimeRange ", "REP_ASR_TC_047"
...
With ivm.page(detailedData_page)
							...
							.webTable("DetailedData_AS").assertValue strTimeRange,"1"
							wait 5	
							.webTable("DetailedData_AS").assertDelValue strTimeRange1
...
End with						  
'End Test Case
executionController.stopTestCase_w_TestCaseNumber "AdvertisementSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateTimeRange ", "REP_ASR_TC_047"