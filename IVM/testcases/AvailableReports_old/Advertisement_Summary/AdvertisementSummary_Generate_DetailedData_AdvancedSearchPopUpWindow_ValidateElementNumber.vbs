...
'
' File Name						:	AdvertisementSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateElementNumber
...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "AdvertisementSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateElementNumber", "REP_ASR_TC_041"
...
With ivm.page(detailedData_page)	
							...
							.webTable("DetailedData_AS").assertValue strElementNumber,"2"
							wait 5	
							.webTable("DetailedData_AS").assertDelValue strElementNumber1
...
REM 'For invalid
							...
							.webTable("DetailedData_AS").assertDelValue strElementNumber
							.webTable("DetailedData_AS").assertDelValue strElementNumber1
							wait 5
...
executionController.stopTestCase_w_TestCaseNumber "AdvertisementSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateElementNumber", "REP_ASR_TC_041"