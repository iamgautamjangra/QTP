...
With ivm.page(detailedData_page)
							...
							.webTable("DetailedData_APD").assertValue strProgramPID,"5"
							wait 5	
							.webTable("DetailedData_APD").assertDelValue strProgramPID1
							.webLink("ClearAll").press
							wait 5
							.webElement("ProgramPID_Filter").assertExist "False"
							
							
							.webTable("DetailedData_APD").assertValue strProgramPID,"7"
							.webTable("DetailedData_APD").assertValue strProgramPID1,"7"
