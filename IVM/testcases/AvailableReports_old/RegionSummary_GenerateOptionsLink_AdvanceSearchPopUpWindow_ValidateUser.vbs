...
'
' File Name						:	RegionSummary_GenerateOptionsLink_AdvanceSearchPopUpWindow_ValidateUser
...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "RegionSummary_GenerateOptionsLink_AdvanceSearchPopUpWindow_ValidateUser", "REP_RSR_TC_006"
...
'---------------Assert Back to previous webLink-----------------------
						...
						.webTable("DataSet").assertExist "True"
							...
							wait Wait5	
							REM .webTable("DataSet").assertDelValue strUser1
...
End with						         						         
'End Test Case				
executionController.stopTestCase_w_TestCaseNumber "RegionSummary_GenerateOptionsLink_AdvanceSearchPopUpWindow_ValidateUser", "REP_RSR_TC_006"			
