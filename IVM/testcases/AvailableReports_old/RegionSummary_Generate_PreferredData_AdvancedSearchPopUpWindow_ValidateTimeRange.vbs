...
'
' File Name						:	RegionSummary_Generate_PreferredData_AdvancedSearchPopUpWindow_ValidateTimeRange 
...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "RegionSummary_Generate_PreferredData_AdvancedSearchPopUpWindow_ValidateTimeRange ", "REP_RSR_TC_028"
...
With ivm.page(preferredData_page)
							...
							.webTable("PreferredData_RS").assertValue strTimeRange,"1"
							wait Wait5	
							.webTable("PreferredData_RS").assertDelValue strTimeRange1
...
End with
executionController.stopTestCase_w_TestCaseNumber "RegionSummary_Generate_PreferredData_AdvancedSearchPopUpWindow_ValidateTimeRange ", "REP_RSR_TC_028"