...
'
' File Name						:	VODAdDeliveryDataFeed_Generate_Channel5Data_NoRecordFound 
' Description					:   Validate the "Channel 5 Data" table when no record is found matching the filter criteria.
' Author 						:   Fonantrix Solution
' Date 							:   15-05-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

'Start Test Case
 executionController.startTestCase_w_TestCaseNumber "VODAdDeliveryDataFeed_Generate_Channel5Data_NoRecordFound ", "REP_VOD_TC_054"
...
'End Test Case 
executionController.stopTestCase_w_TestCaseNumber "VODAdDeliveryDataFeed_Generate_Channel5Data_NoRecordFound", "REP_VOD_TC_054"
