...
With ivm.page(detailedData_page)	
							...
							.webTable("DetailedData_PS").assertValue strClockNumber,"3"
							wait 5	
							.webTable("DetailedData_PS").assertDelValue strClockNumber1
...
REM 'For invalid
							...
							.webTable("DetailedData_PS").assertDelValue strClockNumber
							.webTable("DetailedData_PS").assertDelValue strClockNumber1
							wait 5
