...
'
' File Name						:	ProgramSummary_Generate_DetailedData_ValidateAdvancedSearchPopUpWindow
...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "ProgramSummary_Generate_DetailedData_ValidateAdvancedSearchPopUpWindow", "REP_PSR_TC_041"
...
With ivm.page(detailedData_page)	
						...
						wait 5
							...
							.webElement("ProgramSeriesTitle_Adv").assertExist "True"
							.webElement("ProgramSeriesTitle_Adv").assertStatus "Visible"
							.webEdit("ProgramSeriesTitle_Adv").assertExist "True"
							.webEdit("ProgramSeriesTitle_Adv").assertStatus "Visible"
...
'End Test Case
executionController.stopTestCase_w_TestCaseNumber "ProgramSummary_Generate_DetailedData_ValidateAdvancedSearchPopUpWindow", "REP_PSR_TC_041"