...
'
' File Name						:	ProgramSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateCampaignName
...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "ProgramSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateCampaignName", "REP_PSR_TC_042"
...
With ivm.page(detailedData_page)
							...
							.webTable("DetailedData_PS").assertValue strCampaignName,"2"
							wait 5	
							.webTable("DetailedData_PS").assertDelValue strCampaignName1
...
End with			
'End Test Case
executionController.stopTestCase_w_TestCaseNumber "ProgramSummary_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateCampaignName", "REP_PSR_TC_042"