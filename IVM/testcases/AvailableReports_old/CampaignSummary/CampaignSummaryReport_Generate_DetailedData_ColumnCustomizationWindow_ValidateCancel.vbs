...
'
' File Name						:	CampaignSummaryReport_Generate_DetailedData_ColumnCustomizationWindow_ValidateCancel
' Description					:	Validate cancel operation for "Customize Columns" pop up. 
' Author 						:   Fonantrix Solution
' Date 							:   09-04-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "CampaignSummaryReport_Generate_DetailedData_ColumnCustomizationWindow_ValidateCancel", "REP_CSR_TC_046"
...
'Displayed columns							
							...
							.webTable("DetailedDataHeader_CS").assertCustomizeColumnExist "Clock Number","True"
							.webTable("DetailedDataHeader_CS").assertCustomizeColumnExist "Program PID","True"
							.webTable("DetailedDataHeader_CS").assertCustomizeColumnExist "Unique Customers","True"
							.webTable("DetailedDataHeader_CS").assertCustomizeColumnExist "Advert Placements","True"
							.webTable("DetailedDataHeader_CS").assertCustomizeColumnExist "Advert Full Views","True"
							.webTable("DetailedDataHeader_CS").assertCustomizeColumnExist "Advert Partial Views","True"
							.webTable("DetailedDataHeader_CS").assertCustomizeColumnExist "Advert Fast Forward Views","True"
							.webTable("DetailedDataHeader_CS").assertCustomizeColumnExist "Advert Placements Not Viewed","True"
							.webTable("DetailedDataHeader_CS").assertCustomizeColumnExist "Total Home Views","True"
							.webTable("DetailedDataHeader_CS").assertCustomizeColumnExist "Advert Average Play Time","True"
...
'End Test Case 
 executionController.stopTestCase_w_TestCaseNumber "CampaignSummaryReport_Generate_DetailedData_ColumnCustomizationWindow_ValidateCancel", "REP_CSR_TC_046"