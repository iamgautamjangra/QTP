...
'
' File Name						:	CampaignSummaryReport_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateElementNumber
...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "CampaignSummaryReport_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateElementNumber", "REP_CSR_TC_018"
...
With ivm.page(reportgen_page)	
							...
							.webTable("DetailedData_CS").searchdata strElement
							wait 5	
'For invalid
							.webLink("AdvancedSearch").press
							wait 5
...
DetailedData_AS					
'End Test Case
executionController.stopTestCase_w_TestCaseNumber "CampaignSummaryReport_Generate_DetailedData_AdvancedSearchPopUpWindow_ValidateElementNumber", "REP_CSR_TC_018"