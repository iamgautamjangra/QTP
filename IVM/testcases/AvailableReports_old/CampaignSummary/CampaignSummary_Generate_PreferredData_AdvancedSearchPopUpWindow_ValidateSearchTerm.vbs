...
'
' File Name						:	CampaignSummary_Generate_PreferredData_AdvancedSearchPopUpWindow_ValidateSearchTerm
...
'Start Test Case
 executionController.startTestCase_w_TestCaseNumber "CampaignSummary_Generate_PreferredData_AdvancedSearchPopUpWindow_ValidateSearchTerm", "REP_CSR_TC_032"
...
With ivm.page(reportgen_page)
							...
							.webTable("PreferredData_CS").assertExist "True"													
					        .webTable("PreferredData_CS").assertValue NO_RECORD_FOUND
							wait 5
...
'Search with valid data
							...
							.webTable("PreferredData_CS").assertExist "True"													
					        .webTable("PreferredData_CS").assertTableData 'TBD SearchTermValid
							wait 5
...
'End Test Case 
executionController.stopTestCase_w_TestCaseNumber "CampaignSummary_Generate_PreferredData_AdvancedSearchPopUpWindow_ValidateSearchTerm", "REP_CSR_TC_032"
