...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "CampaignSummary_Generate_PreferredData_AdvancedSearchPopUpWindow_ValidateProgramPID", "REP_CSR_TC_029"
...
With ivm.page(reportgen_page)	
							...
							.webTable("PreferredData_CS").assertTableData 'TBD strProgram
							wait 5	
'For invalid
							.webLink("AdvancedSearch").press
							wait 5
...
'End Test Case
executionController.stopTestCase_w_TestCaseNumber "CampaignSummary_Generate_PreferredData_AdvancedSearchPopUpWindow_ValidateProgramPID", "REP_CSR_TC_029"