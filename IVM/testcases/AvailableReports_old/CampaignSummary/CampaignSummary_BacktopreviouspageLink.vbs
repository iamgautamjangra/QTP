...
' Description					:	Validate the "Back to Previous Page" link in "CSR Ad Delivery Data Feed" page.
' Author 						:   Fonantrix Solution
' Date 							:   14-05-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

'Start Test Case
executionController.startTestCase_w_TestCaseNumber "CampaignSummary_BacktopreviouspageLink", "REP_CSR_TC_011"
...
'End Test Case
executionController.stopTestCase_w_TestCaseNumber "CampaignSummary_BacktopreviouspageLink", "REP_CSR_TC_011"