...
With ivm.page(ScheduledReports_Page)
			...
			strReportTime=Trim(ivm.page(ScheduledReports_Page).webTable("ScheduledReports").getCellValue(reportRegionSummary,3))
			
			strReportTime=Replace(strReportTime," ","")
			strReportTime=Mid(strReportTime,11,8)						
									
									
		 .assertFormrecord reportRegionSummary,SCHEDULED_DATE & strReportTime,strUiVal,"True"
