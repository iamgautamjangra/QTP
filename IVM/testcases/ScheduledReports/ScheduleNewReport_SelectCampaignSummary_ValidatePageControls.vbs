...
'
' File Name						:	ScheduleNewReport_SelectCampaignSummary_ValidatePageControls
' Description					:	Validate the Page Controls of the Schedule new report page.
' Author 						:   SeaChange
' Date 							:   16-05-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

executionController.startTestCase_w_TestCaseNumber "ScheduleNewReport_SelectCampaignSummary_ValidatePageControls", "SCR_NEW_CSR_TC_001"
...
executionController.stopTestCase_w_TestCaseNumber "ScheduleNewReport_SelectCampaignSummary_ValidatePageControls", "SCR_NEW_CSR_TC_001"
