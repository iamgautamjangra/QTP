...
With ivm.page(ScheduledReports_Page)
			...
			strReportTime=Trim(ivm.page(ScheduledReports_Page).webTable("ScheduledReports").getCellValue(reportAdvertisementandProgramDetails,3))
			
			strReportTime=Replace(strReportTime," ","")
			strReportTime=Mid(strReportTime,11,8)						
									
									
		 .assertFormrecord reportAdvertisementandProgramDetails,SCHEDULED_DATE & strReportTime,strUiVal,"True"
