...
With ivm.page(ScheduledReports_Page)
			...
			strReportTime=Trim(ivm.page(ScheduledReports_Page).webTable("ScheduledReports").getCellValue(reportAdvertisementSummary,3))
			
			strReportTime=Replace(strReportTime," ","")
			strReportTime=Mid(strReportTime,11,8)						
									
									
		 .assertFormrecord reportAdvertisementSummary,SCHEDULED_DATE & strReportTime,strUiVal,"True"
