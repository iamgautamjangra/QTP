...
'
' File Name						:	ScheduleNewReport_SelectRegionSummary_ValidatePageControls
' Description					:	Validate the Page Controls of the Schedule new report page.
' Author 						:   SeaChange
' Date 							:   03-07-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

executionController.startTestCase_w_TestCaseNumber "ScheduleNewReport_SelectRegionSummary_ValidatePageControls", "SCR_NEW_RSR_TC_001"
...
executionController.stopTestCase_w_TestCaseNumber "ScheduleNewReport_SelectRegionSummary_ValidatePageControls", "SCR_NEW_RSR_TC_001"
