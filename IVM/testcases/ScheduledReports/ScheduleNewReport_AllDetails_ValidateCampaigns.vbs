...
'
' File Name						:	ScheduleNewReport_AllDetails_ValidateCampaigns
...
'Start Test Case
 executionController.startTestCase_w_TestCaseNumber "ScheduleNewReport_AllDetails_ValidateCampaigns", "SCR_NEW_ADR_TC_005"
...
strCampaign1=testcasedata.getvalue("strCampaign1")
 ...
 With ivm.page(ScheduledReports_Page)
							...
							.assertListItems MULTI_LIST_CAMPAIGN & ";" & reportAllDetails,FIRST_DATE & ";"& LAST_DATE
							wait Wait5
							.assertListDGWDB MULTI_LIST_CAMPAIGN & ";"& reportAllDetails,FIRST_DATE & ";"& LAST_DATE
					  	   wait Wait5
...
'End Test Case 
executionController.stopTestCase_w_TestCaseNumber "ScheduleNewReport_AllDetails_ValidateCampaigns", "SCR_NEW_ADR_TC_005"
