...
'
' File Name						:	ScheduleNewReport_SelectRawData_ValidatePageControls
' Description					:	Validate the Page Controls of the Schedule new report page.
' Author 						:   SeaChange
' Date 							:   30-05-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

executionController.startTestCase_w_TestCaseNumber "ScheduleNewReport_SelectRawData_ValidatePageControls", "SCR_NEW_RDR_TC_001"
...
with ivm.page(ScheduledReports_Page)
								    ...
								    .webRadiogroup("Site_SiteGroup").assertExist "True"
									.webRadiogroup("Site_SiteGroup").assertStatus "Visible"
									...
									REM '.webElement("GroupBy").assertStatus "Visible"
									REM '.webList("GroupBy").assertExist "True"
									REM '.webList("GroupBy").assertStatus "Visible"
...
executionController.stopTestCase_w_TestCaseNumber "ScheduleNewReport_SelectRawData_ValidatePageControls", "SCR_NEW_RDR_TC_001"
