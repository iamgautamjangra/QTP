...
'
' File Name						:	ScheduleNewReport_SelectProgramSummary_ValidatePageControls
' Description					:	Validate the Page Controls of the Schedule new report page.
' Author 						:   SeaChange
' Date 							:   02-07-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

executionController.startTestCase_w_TestCaseNumber "ScheduleNewReport_SelectProgramSummary_ValidatePageControls", "SCR_NEW_PSR_TC_001"
...
executionController.stopTestCase_w_TestCaseNumber "ScheduleNewReport_SelectProgramSummary_ValidatePageControls", "SCR_NEW_PSR_TC_001"
