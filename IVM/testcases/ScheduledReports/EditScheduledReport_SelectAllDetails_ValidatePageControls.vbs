...
'
' File Name						:	EditScheduledReport_SelectAllDetails_ValidatePageControls
' Description					:	Validate the Page Controls of the Edit Report.
' Author 						:   SeaChange
' Date 							:   16-05-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

executionController.startTestCase_w_TestCaseNumber "EditScheduledReport_SelectAllDetails_ValidatePageControls", "SCR_EDIT_ADR_TC_001"
...
with ivm.page(ScheduledReports_Page)
									...
									wait Wait20
				                    SearchVal="All Details" & ";" & "Every day at " & SCHEDULED_TIME &";" & "Edit Options"
									...
									.webElement("ReportName_AD").assertExist "True"
									.webElement("ReportName_AD").assertStatus "Visible"
									.webElement("ReportName_AD").assertText "Report Name: "& reportAllDetails
									
									.webElement("Description_AD").assertExist "True"
									.webElement("Description_AD").assertStatus "Visible"
									.webElement("Description_AD").assertText "Description: "& Desc_AD
...
executionController.stopTestCase_w_TestCaseNumber "EditScheduledReport_SelectAllDetails_ValidatePageControls", "SCR_EDIT_ADR_TC_001"
