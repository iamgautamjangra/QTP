...
'
' File Name						:	EditScheduledReport_SelectAdvertisementSummary_ValidatePageControls
' Description					:	Validate the Page Controls of the Edit Report.
' Author 						:   SeaChange
' Date 							:   05-07-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

executionController.startTestCase_w_TestCaseNumber "EditScheduledReport_SelectAdvertisementSummary_ValidatePageControls", "SCR_EDIT_ASR_TC_001"
...
with ivm.page(ScheduledReports_Page)
				                    ...
				                    SearchVal="Advertisement Summary" & ";" & "Every day at " & strTime &";" & "Edit Options"
									...
									.webElement("ReportName_AS").assertExist "True"
									.webElement("ReportName_AS").assertStatus "Visible"
									.webElement("ReportName_AS").assertText "Report Name: "& reportAdvertisementSummary
									
									.webElement("Description_AS").assertExist "True"
									.webElement("Description_AS").assertStatus "Visible"
									.webElement("Description_AS").assertText "Description: "& Desc_AS
...
executionController.stopTestCase_w_TestCaseNumber "EditScheduledReport_SelectAdvertisementSummary_ValidatePageControls", "SCR_EDIT_ASR_TC_001"
