...
'
' File Name						:	EditScheduledReport_SelectAdvertisementandProgramDetails_ValidatePageControls
' Description					:	Validate the Page Controls of the Edit Report.
' Author 						:   SeaChange
' Date 							:   05-07-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

executionController.startTestCase_w_TestCaseNumber "EditScheduledReport_SelectAdvertisementandProgramDetails_ValidatePageControls", "SCR_EDIT_APDR_TC_001"
...
with ivm.page(ScheduledReports_Page)
			                       ...
			                       .webLink("ScheduleNewReport").press
									...
									SearchVal="Advertisement And Program Details" & ";" & "Every day at " & SCHEDULED_TIME &";" & "Edit Options"
									...
									.webElement("ReportName_APD").assertExist "True"
									.webElement("ReportName_APD").assertStatus "Visible"
									.webElement("ReportName_APD").assertText "Report Name: "& reportAdvertisementandProgramDetails
									
									.webElement("Description_APD").assertExist "True"
									.webElement("Description_APD").assertStatus "Visible"
									.webElement("Description_APD").assertText "Description: "& Desc_APD
...
executionController.stopTestCase_w_TestCaseNumber "EditScheduledReport_SelectAdvertisementandProgramDetails_ValidatePageControls", "SCR_EDIT_APDR_TC_001"
