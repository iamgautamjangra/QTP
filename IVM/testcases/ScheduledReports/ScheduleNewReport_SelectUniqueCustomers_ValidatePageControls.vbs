...
'
' File Name						:	ScheduleNewReport_SelectUniqueCustomers_ValidatePageControls
' Description					:	Validate the Page Controls of the Schedule new report page.
' Author 						:   SeaChange
' Date 							:   05-07-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

executionController.startTestCase_w_TestCaseNumber "ScheduleNewReport_SelectUniqueCustomers_ValidatePageControls", "SCR_NEW_ASR_TC_001"
...
executionController.stopTestCase_w_TestCaseNumber "ScheduleNewReport_SelectUniqueCustomers_ValidatePageControls", "SCR_NEW_ASR_TC_001"
