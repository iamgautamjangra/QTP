...
With ivm.page(ScheduledReports_Page)
			...
			strReportTime=Trim(ivm.page(ScheduledReports_Page).webTable("ScheduledReports").getCellValue(reportCampaignSummary,3))
			
			strReportTime=Replace(strReportTime," ","")
			strReportTime=Mid(strReportTime,11,10)
			strReportTime=ConvertTime(strReportTime)
			
									
									
		 .assertFormrecord reportCampaignSummary,SCHEDULED_DATE & strReportTime,strUiVal,"True"
