...
'
' File Name						:	EditScheduledReport_SelectProgramSummary_ValidatePageControls
' Description					:	Validate the Page Controls of the Edit Report.
' Author 						:   SeaChange
' Date 							:   02-07-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

executionController.startTestCase_w_TestCaseNumber "EditScheduledReport_SelectProgramSummary_ValidatePageControls", "SCR_EDIT_PSR_TC_001"
...
With ivm.page(ScheduledReports_Page)
									...
									.webButton("Schedule").press
									  ...
									  wait Wait15
									   SearchVal="Program Summary" & ";" & "Every day at " & strTime &";" & "Edit Options"
									...
									.webElement("ReportName_PS").assertExist "True"
									.webElement("ReportName_PS").assertStatus "Visible"
									.webElement("ReportName_PS").assertText "Report Name: "& reportProgramSummary
									
									.webElement("Description_PS").assertExist "True"
									.webElement("Description_PS").assertStatus "Visible"
									.webElement("Description_PS").assertText "Description: "& Desc_PS
...
executionController.stopTestCase_w_TestCaseNumber "EditScheduledReport_SelectProgramSummary_ValidatePageControls", "SCR_EDIT_PSR_TC_001"
