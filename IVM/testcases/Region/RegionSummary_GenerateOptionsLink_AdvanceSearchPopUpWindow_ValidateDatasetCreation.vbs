...
'
' File Name						:	RegionSummary_GenerateOptionsLink_AdvanceSearchPopUpWindow_ValidateDatasetCreation
...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "RegionSummary_GenerateOptionsLink_AdvanceSearchPopUpWindow_ValidateDatasetCreation", "REP_RSR_TC_006"
...
'---------------Assert Back to previous webLink-----------------------
						...
						.webEdit("DatasetCreation").setValue strDetasetCreation
...
REM 'For invalid
							...
							.webEdit("DatasetCreation").setValue strDetasetCreationInv
						    wait Wait2
							.webLink("AdvSearch").press
							wait Wait5	
...
End with								         
'End Test Case				
executionController.stopTestCase_w_TestCaseNumber "RegionSummary_GenerateOptionsLink_AdvanceSearchPopUpWindow_ValidateDatasetCreation", "REP_RSR_TC_006"			
