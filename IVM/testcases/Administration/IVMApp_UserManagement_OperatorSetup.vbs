...
wait 2
ivm.page(Login_page).webEdit("Username").setValue Environment.Value("OPERATOR_USER")
 ivm.page(Login_page).webEdit("Password").setValue Environment.Value("OPERATOR_PASSWORD")
