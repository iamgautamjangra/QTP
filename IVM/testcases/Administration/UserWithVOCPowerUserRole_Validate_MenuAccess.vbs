...
'
' File Name						:	UserWithVOCPowerUserRole_Validate_MenuAccess
...
'Start Test Case
executionController.startTestCase_w_TestCaseNumber "UserWithVOCPowerUserRole_Validate_MenuAccess","RBAC_008"
...
'----------------------------------Alert Settings-------------------------------------------	
    ...
    ivm.page(Common_page).webLink("LocationManager").assertExist "False"
	ivm.page(Common_page).webLink("LocationManager").assertStatus "Not Visible" 	
...
wait 7
'End Test Case
executionController.stopTestCase_w_TestCaseNumber "UserWithVOCPowerUserRole_Validate_MenuAccess", "RBAC_008"
