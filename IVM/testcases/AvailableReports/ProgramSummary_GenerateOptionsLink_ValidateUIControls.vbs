...
'
' File Name						:	ProgramSummary_GenerateOptionsLink_ValidateUIControls
' Description					:   Validate Default view Controls of "ProgramSummary" report..			
' Author 						:   Fonantrix Solution
' Date 							:   01-07-2013
'--------------------------------------------------------------------------------------------------------------------------------------------------

'Start Test Case
executionController.startTestCase_w_TestCaseNumber "ProgramSummary_GenerateOptionsLink_ValidateUIControls", "REP_PSR_TC_002"
...
'---------------Assert header-----------------------------------------
						...
						.webElement("GenerateReport").assertText "Generate "& reportProgramSummary & " Report"

'---------------Assert label description----------------------------------
						.webElement("Description_PS").assertExist "True"
						.webElement("Description_PS").assertStatus "Visible"
						.webElement("Description_PS").assertText Desc_PS
...
'End Test Case
executionController.stopTestCase_w_TestCaseNumber "ProgramSummary_GenerateOptionsLink_ValidateUIControls", "REP_PSR_TC_002"