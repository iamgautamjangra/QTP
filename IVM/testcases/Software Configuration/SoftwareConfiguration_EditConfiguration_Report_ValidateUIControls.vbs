...
'
' File Name						:	SoftwareConfiguration_EditConfiguration_Report_ValidateUIControls
...
executionController.startTestCase_w_TestCaseNumber "SoftwareConfiguration_EditConfiguration_Report_ValidateUIControls", "SOF_CONF_TC_001"
...
With ivm.page(SoftwareConfiguration_page)
        ...
        .webElement("EmailSettings").assertExist "True"
		.webElement("EmailSettings").assertStatus "Visible"
		
		
		.webEdit("EMAIL_Default").assertExist "True"
		.webEdit("EMAIL_Default").assertStatus "Visible"
		
		.webEdit("EMAIL_PASSWORD").assertExist "True"
		.webEdit("EMAIL_PASSWORD").assertStatus "Visible"
		
		.webEdit("EMAIL_SMTP_HOST").assertExist "True"
		.webEdit("EMAIL_SMTP_HOST").assertStatus "Visible"
		...
		.webLink("SaveChanges_2").assertExist "True"
		.webLink("SaveChanges_2").assertStatus "Visible"
		
		.webLink("Cancel_2").assertExist "True"
		.webLink("Cancel_2").assertStatus "Visible"
		
End with

'End Test Case
 executionController.stopTestCase_w_TestCaseNumber "SoftwareConfiguration_EditConfiguration_Report_ValidateUIControls", "SOF_CONF_TC_001"
